          ...
          <Container maxWidth="sm">
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                saPerYear: Yup.number()
                  .integer()
                  .required('กรุณากรอกทุนประกันภัยที่ต้องการ')
              })}
                ...
                <form onSubmit={handleSubmit}>
                  <Box mb={2}>
                    <Typography color="textPrimary" variant="h4">
                      คำนวนเบี้ยประกันโดยระบุทุนประกัน
                    </Typography>
                  </Box>
                  ...
                  <TextField
                    error={Boolean(touched.saPerYear && errors.saPerYear)}
                    fullWidth
                    helperText={touched.saPerYear && errors.saPerYear}
                    label="ทุนประกันภัยที่ต้องการ"
                    margin="normal"
                    name="saPerYear"
                    onBlur={handleBlur}
                    onChange={handleChange}
                    value={values.saPerYear}
                    variant="outlined"
                    type="number"
                    inputProps={{
                      maxLength: 30
...
export default CalculationPremium;
